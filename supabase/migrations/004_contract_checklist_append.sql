...
begin
  ...
  where id = signer_id and first_name_slug = cleaned_slug
...
revoke all on function public.append_contract_checklist_item(text, uuid, text) from public;
grant execute on function public.append_contract_checklist_item(text, uuid, text) to anon;
grant execute on function public.append_contract_checklist_item(text, uuid, text) to authenticated;
